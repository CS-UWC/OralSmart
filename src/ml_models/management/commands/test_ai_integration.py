    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            if ml_prediction['available']:
                ...
                self.stdout.write(self.style.WARNING(f"⚠️  ML Prediction not available: {ml_prediction.get('error', 'Unknown error')}"))
        ...
        try:
            ...
            if professional_size > patient_size:
                ...
                self.stdout.write(self.style.WARNING(f"⚠️  Professional PDF is not larger than patient PDF (size difference: {professional_size - patient_size:,} bytes)"))
        ...
        try:
            ...
            if predictor.is_trained:
                ...
                self.stdout.write(self.style.WARNING("⚠️  ML model is not trained - predictions will show 'Unknown' status"))
